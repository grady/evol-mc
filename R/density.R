...
means <- replicate(20, runif(3,-10,10))
...
target <- function(x){
  ...
  rowMeans(apply(means,2,df))
}

##rowMeans(apply(means,2,function(mean) dmvnorm(matrix(1:12,4,3),mean,diag(3)/10)))
target(matrix(1:12,4,3))
