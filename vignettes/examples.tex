...
##    mean      se    2.5%   97.5% 
## 1.08170 0.72125 0.04479 2.59042
\end{verbatim}
\begin{alltt}
...
## Discarding first 1000 states.
##          mean   var   kappa
## mean  27.3938 12.80 0.50363
## se     0.5779  3.71 0.28606
## 2.5%  26.2685  7.07 0.02597
## 97.5% 28.5155 21.86 0.97205
\end{verbatim}
\begin{alltt}
\hlkwd{plot}\hlstd{(chain4)}
\end{alltt}
...
\hlstd{lineage} \hlkwb{<-} \hlkwd{iterate}\hlstd{(}\hlnum{1000}\hlstd{, evolve, init)}
\end{alltt}
\end{kframe}
\end{knitrout}
