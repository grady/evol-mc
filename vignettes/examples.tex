...
\hlkwd{invisible}\hlstd{(}\hlkwd{sapply}\hlstd{(t}\hlopt{:}\hlnum{1}\hlstd{,} \hlkwa{function}\hlstd{(}\hlkwc{i}\hlstd{) pp}\hlopt{$}\hlkwd{points3d}\hlstd{(m[, , i],} \hlkwc{col} \hlstd{= i} \hlopt{+} \hlnum{1}\hlstd{)))}
